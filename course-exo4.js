...
const jonas = {
  ...
  //on peut mettre this dans console.log pour que l'objet jonas s'affiche
    ...
    getSummary: function() {
        ...
        return ` ${this.firstName} is a ${this.job} , and he has ${this.hasDriversLicense ? 'a' : 'no'} drivers license.`;
      }
    };

    jonas.birthYear = '2001';
...
const driverLicense = function hasOrNoDriverLicense() {
        if (jonas.hasDriversLicense) { return "a" ;} else {return "no"; } 
        return;
    } 
    ...
    driverLicense();
console.log(jonas.calcAge());
    console.log(`${jonas.firstName} is a ${jonas.calcAge()} years old ${jonas.job} , and he has ${driverLicense()} driver license.  `);
